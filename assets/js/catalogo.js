...
function renderCatalogo(lista){
  ...
  cont.innerHTML=""; if(!Array.isArray(lista)||!lista.length){cont.innerHTML=<p>No hay productos para la categoría seleccionada.</p>;return;}
...
function initCatalogo(){
  ...
  if(cont){
    cont.addEventListener("click",(e)=>{
      ...
      if(addBtn){
        const id=addBtn.closest(".producto")?.dataset.id;
      ...
      if(detBtn){
        const id=detBtn.closest(".producto")?.dataset.id;
